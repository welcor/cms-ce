...
<h1>Admin / <a href="${baseUrl}/adminpage?page=1050&op=browse">Content handler</a> / Cluster Settings</h1>

<div class="infoBox">
    <h2>Cluster settings</h2>
    <ul>
    [#list clusterSettings?keys?sort as key]
        <li><span style="color: #000080">${key}</span> <b>=</b>
            <span style="color: #008000">${clusterSettings[key]}</span></li>
    [/#list]
    </ul>
</div>

<div class="infoBox">
    <form action="clusterSettings" method="post">
        <table>
