...
tinyMCEPopup = {
    ...
    _onDOMLoaded : function() {
        ...
        /*
            2013-04-29 (tan@enonic.com)
            CMS-373 Chrome hangs after editing html source code of a htmlarea

            The resizeToInnerSize call is removed as it created window resizing bugs in Chrome
            The resizeToInnerSize is legacy tinymce code and various third party tinymce plug-ins and does not affect the CMS

            The issue will probably be fixed by TinyMCE later
            https://github.com/tinymce/tinymce/pull/138
        */
