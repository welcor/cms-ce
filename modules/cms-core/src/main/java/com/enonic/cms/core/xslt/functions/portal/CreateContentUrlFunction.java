...
final class CreateContentUrlFunction
    extends AbstractPortalFunction
{
        ...
        extends AbstractXsltFunctionCall
    {
            ...
            throws XPathException
        {
            ...
            final String result = getPortalFunctions().createContentUrl( contentKey, params );
            return createValue( result );
        }
    }

    public CreateContentUrlFunction()
    {
        super( "createContentUrl" );
