    ...
    extends AbstractDataSourceConverterTest
{
    ...
    @Test
    public void testConvert_getContentBySection()
        throws Exception
    {
    ...
    @Test
    public void testConvert_getCategories()
        throws Exception
    {
        testConvert( "task2/getCategories" );
    }

    @Test
    public void testConvert_findContentByCategory()
        throws Exception
    {
