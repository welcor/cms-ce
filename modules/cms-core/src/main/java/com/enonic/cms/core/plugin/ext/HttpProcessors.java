...
public abstract class HttpProcessors<T extends HttpProcessor>
    extends ExtensionPoint<T>
{
    public HttpProcessors( final Class<T> type )
    {
        super( type );
    }

    public final Iterable<T> findMatching( final String path )
    {
