...
public class PluginConfigHelperTest
{
    ...
    {
        final HashMap<String, String> defProperties = new HashMap<String, String>();
        defProperties.put( "external1", "x1" );
        defProperties.put( "external2", "x2" );
        ...
        final Map<String, String> target = PluginConfigHelper.interpolate(defProperties, source);
