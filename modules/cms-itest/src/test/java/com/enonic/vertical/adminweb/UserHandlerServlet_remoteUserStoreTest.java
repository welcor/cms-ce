...
public class UserHandlerServlet_remoteUserStoreTest
    extends AbstractSpringTest
{
        ...
        throws Exception
    {
        ...
        properties.setProperty( "cms.userstore.connector." + DEFAULT_USERSTORE_NAME + "." + "userPolicy", "" );
        properties.setProperty( "cms.userstore.connector." + DEFAULT_USERSTORE_NAME + "." + "groupPolicy", "read" );
