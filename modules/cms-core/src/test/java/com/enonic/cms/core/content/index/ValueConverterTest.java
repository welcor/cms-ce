...
public class ValueConverterTest
{
    ...
    public void testDateTimeConversions()
    {
        ...
        final ReadableDateTime date = ValueConverter.toDate( "2012-02-14" );
        final DateTime dateExpected = new DateTime( 2012, 2, 14, 0, 0, DateTimeZone.getDefault() );
        assertDateTimeEquals( date, dateExpected );

        final ReadableDateTime dateSingleDigit = ValueConverter.toDate( "2012-2-5" );
        ...
        final ReadableDateTime dateTimeSeconds = ValueConverter.toDate( "2012-02-14 13:35:57" );
        ...
        final ReadableDateTime dateTimeMinutes = ValueConverter.toDate( "2012-02-14 13:35" );
        ...
        final ReadableDateTime dateTimeSecondsSep = ValueConverter.toDate( "2012-02-14T13:35:57" );
        ...
        final ReadableDateTime dateTimeMilliseconds = ValueConverter.toDate( "2012-02-14T13:35:57.000" );
        ...
        final ReadableDateTime dateTimeZone = ValueConverter.toDate( "2012-02-14T13:35:57.000Z" );
        ...
        final ReadableDateTime dateTimeZoneLowerCase = ValueConverter.toDate( "2012-02-14T13:35:57.000Z".toLowerCase() );
        ...
        final ReadableDateTime dateTimeZonePlusOne = ValueConverter.toDate( "2012-02-14T13:35:57.000+01:00" );
        ...
        final ReadableDateTime dateTimeZoneMinusOne = ValueConverter.toDate( "2012-02-14T13:35:57.000-01:00" );
        ...
        final ReadableDateTime dateTimeZoneHoursMinutes = ValueConverter.toDate( "2012-02-14T13:35:57.000+02:45" );
