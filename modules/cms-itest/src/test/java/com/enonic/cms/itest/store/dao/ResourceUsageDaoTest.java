    ...
    extends AbstractSpringTest
{
        ...
        throws Exception
    {
        ...
        contentTypeEntity.setDefaultCssKey( new ResourceKey( "CONTENT_TYPE_CSS" ) );
        ...
        throws Exception
    {
        ...
        assertEquals( 1, resourceUsageDao.getUsageCountMap().get( new ResourceKey( "CONTENT_OBJECT_STYLE" ) ).intValue() );

        createSite( 2 );
        assertEquals( 9, resourceUsageDao.getUsageCountMap().size() );
        assertEquals( 2, resourceUsageDao.getUsageCountMap().get( new ResourceKey( "CONTENT_OBJECT_STYLE" ) ).intValue() );
    }
    ...
    public void testGetUsedBy()
        throws Exception
    {
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_OBJECT_STYLE" ) ).size() );
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_OBJECT_BORDER" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_TYPE_CSS" ) ).size() );
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "PAGE_TEMPLATE_STYLE" ) ).size() );
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "PAGE_TEMPLATE_CSS" ) ).size() );

        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "DEFAULT_CSS" ) ).size() );
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "DEFAULT_LOCALIZATION_RESOURCE" ) ).size() );
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "DEVICE_CLASS_RESOLVER" ) ).size() );
        assertEquals( 0, resourceUsageDao.getUsedBy( new ResourceKey( "LOCALE_RESOLVER" ) ).size() );

        createSite( 1 );

        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_OBJECT_STYLE" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_OBJECT_BORDER" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_TYPE_CSS" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "PAGE_TEMPLATE_STYLE" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "PAGE_TEMPLATE_CSS" ) ).size() );

        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "DEFAULT_CSS" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "DEFAULT_LOCALIZATION_RESOURCE" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "DEVICE_CLASS_RESOLVER" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "LOCALE_RESOLVER" ) ).size() );

        createSite( 2 );

        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_OBJECT_STYLE" ) ).size() );
        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_OBJECT_BORDER" ) ).size() );
        assertEquals( 1, resourceUsageDao.getUsedBy( new ResourceKey( "CONTENT_TYPE_CSS" ) ).size() );
        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "PAGE_TEMPLATE_STYLE" ) ).size() );
        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "PAGE_TEMPLATE_CSS" ) ).size() );

        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "DEFAULT_CSS" ) ).size() );
        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "DEFAULT_LOCALIZATION_RESOURCE" ) ).size() );
        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "DEVICE_CLASS_RESOLVER" ) ).size() );
        assertEquals( 2, resourceUsageDao.getUsedBy( new ResourceKey( "LOCALE_RESOLVER" ) ).size() );
    }
    ...
    private void createSite( int n )
    {
        ...
        final PageTemplateEntity pageTemplateEntity =
            factory.createPageTemplate( "my-page-template", PageTemplateType.CONTENT, "The Newspaper " + n,
                                        new ResourceKey( "PAGE_TEMPLATE_CSS" ) );
        pageTemplateEntity.setCssKey( new ResourceKey( "PAGE_TEMPLATE_STYLE" ) );
        ...
        portlet.setStyleKey( new ResourceKey( "CONTENT_OBJECT_STYLE" ) );
        portlet.setBorderKey( new ResourceKey( "CONTENT_OBJECT_BORDER" ) );
