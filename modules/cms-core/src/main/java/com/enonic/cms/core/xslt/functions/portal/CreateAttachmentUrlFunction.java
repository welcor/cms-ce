...
final class CreateAttachmentUrlFunction
    extends AbstractPortalFunction
{
        ...
        extends AbstractXsltFunctionCall
    {
        ...
        {
            final String nativeLinkKey = toSingleString( args[0] );
            ...
            final String result = getPortalFunctions().createAttachmentUrl( nativeLinkKey, params );
            return createValue( result );
        }
    }

    public CreateAttachmentUrlFunction()
    {
        super( "createAttachmentUrl" );
